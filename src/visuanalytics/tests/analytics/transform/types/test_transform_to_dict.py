...
class TestTransformToDict(unittest.TestCase):
    def setUp(self):
        self.data = {
            "list": ["Canada", 5, "Argentina", 3, "Cyprus", 2, "Schweden", 1, "Norway", 4, "USA", 5, "Germany", 7,
                     "United Kingdom", 8, "Z", 10],
            "string": "Canada 5 Argentina 3 Cyprus 2 Schweden 1 Norway 4 USA 5 Germany 7 United Kingdom 8 Z 10",
    ...
    def test_to_dict_string(self):
        ...
        expected_data = {
            "_req": {
                ...
                "tuple": [("Canada", 5), ("Argentina", 3), ("Cyprus", 2), ("Schweden", 1), ("Norway", 4), ("USA", 5),
                          ("Germany", 7), ("United Kingdom", 8), ("Z", 10)],
                "dict_string": {"Canada": 5, "Argentina": 3, "Cyprus": 2, "Schweden": 1, "Norway": 4,
                                "USA": 5, "Germany": 7, "United Kingdom": 8, "Z": 10}
            }
        }

        exp, out = prepare_test(values, self.data, expected_data)
        self.assertDictEqual(exp, out, "to_dict string failed")
