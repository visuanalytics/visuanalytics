...
export const SceneEditor: React.FC<SceneEditorProps> = (props) => {
  ...
  const saveSceneHandle = () => {
    //TODO Save scene and send stuff to backend 
  }
        ...
        <Grid item container justify={"center"} xs={12}>
          <Grid item container xs={7}>
            <Grid item container xs={12} justify={"space-evenly"}>
              ...
              <Grid item>
                <Button size={"large"} variant={"contained"} className={classes.topButtons} onClick={props.backHandler}>
                  Zurück
                </Button>
              </Grid>
              <Grid item>
