...
export const EditSingleFormelGUI: React.FC<EditSingleFormelGUIProps> = (
  props
) => {
      ...
      <Grid container>
        ...
        <Grid item container xs={12} justify={"space-around"}>
          ...
          <Grid item className={classes.blockableButtonSecondary}>
            <Button
              disabled={
                props.rightParenCount >= props.leftParenCount ||
                props.rightParenFlag
              }
              variant={"contained"}
              size={"large"}
              color={"primary"}
        ...
        <Grid item container xs={12} justify={"space-around"}>
          ...
          <Grid item className={classes.blockableButtonSecondary}>
            <Button
              ...
              size={"large"}
              color={"primary"}
              disabled={props.commaFlag || props.isCommaUsed}
          ...
          >
            <Grid item container xs={12}>
              <Grid item xs={10}>
                <Typography
                  variant="h6"
                  className={classes.customDataSelectionTitle}
                >
                  Formeln
                </Typography>
              </Grid>
              ...
              <Grid item xs={12}>
                <Collapse in={showCustomData}>
                  <List>
                    {props.customData
                      .slice()
                      .sort((a, b) => a.formelName.localeCompare(b.formelName))
                      .map((name) => renderListItemCustomData(name.formelName))}
                  </List>
                </Collapse>
              </Grid>
            </Grid>
                ...
                <Collapse in={showSelectedData}>
                  <List>
                    {props.selectedData
                      ...
                      .map((item) => renderListItemSelectedData(item))}
                  </List>
                </Collapse>
              </Grid>
            </Grid>
            <Grid item container xs={12}>
              ...
              <Grid item xs={2}>
                {!showArrayProcessings && (
                  <IconButton
                    aria-label="Array-Verarbeitungen ausklappen"
                    onClick={() =>
                      setShowArrayProcessings(!showArrayProcessings)
                    }
                  >
                    <ExpandMore />
                  </IconButton>
                ...
                {showArrayProcessings && (
                  <IconButton
                    aria-label="Array-Verarbeitungen einklappen"
                    onClick={() =>
                      setShowArrayProcessings(!showArrayProcessings)
                    }
                  >
                ...
                <Collapse in={showArrayProcessings}>
                  <List>
                    {props.arrayProcessingsList.map((item) =>
                      renderArrayProcessing(item.name)
                    )}
                  </List>
                </Collapse>
              </Grid>
