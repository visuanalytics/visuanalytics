 ...
 */
export const EditDataCustomization: React.FC<EditDataCustomizationProps> = (
  props
) => {
    ...
    switch (props.dataCustomizationStep) {
      case 0: {
        return (
          <ArrayProcessing
            continueHandler={() =>
              props.setDataCustomizationStep(props.dataCustomizationStep + 1)
            }
        ...
        return (
          <EditCustomData
            continueHandler={(index) =>
              props.setDataCustomizationStep(
                props.dataCustomizationStep + index
              )
            }
            backHandler={() =>
              props.setDataCustomizationStep(props.dataCustomizationStep - 1)
        ...
        return (
          <EditSingleFormel
            ...
            setInfoProvDataSources={(dataSources: Array<DataSource>) =>
              props.setInfoProvDataSources(dataSources)
            }
            selectedDataSource={props.selectedDataSource}
            reportError={props.reportError}
      ...
      case 3: {
        return (
          <StringProcessing
            ...
            backHandler={() =>
              props.setDataCustomizationStep(props.dataCustomizationStep - 2)
            }
            reportError={props.reportError}
            stringReplacementList={
              props.infoProvDataSources[props.selectedDataSource]
