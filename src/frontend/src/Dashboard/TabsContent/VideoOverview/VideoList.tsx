...
export const VideoList: React.FC<VideoListProps> = (props) => {
    ...
    return (
      <ListItem key={data.videojob_name}>
        <Grid container justify="space-between">
          <Grid item xs={7}>
            <Box border={5} borderRadius={10} className={classes.videoBorder}>
            ...
            <Grid item xs={5}>
              ...
              <Grid item xs={12} /*className={classes.logIconTopMargin}*/>
                <Button
                  ...
                  onClick={() =>
                    openLogDialog(data.videojob_id, data.videojob_name)
                  }
                >
                  Logs
                </Button>
  ...
  return (
    <React.Fragment>
      ...
      >
        <List>{props.videos.map((e) => renderVideoListItem(e))}</List>
      </Box>
      {showLogDialog && (
        <LogDialog
