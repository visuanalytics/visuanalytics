...
export const InfoProviderList: React.FC<InfoProviderListProps> = (props) => {
  ...
  const [selectedInfoproviderID, setSelectedInfoproviderID] =
    React.useState(-1);

  // This state is used to pass the name of the infoprovider to the LogDialog
  const [selectedInfoproviderName, setSelectedInfoproviderName] =
    React.useState("");
      ...
      <ListItem key={data.infoprovider_name}>
        ...
        <Grid container justify="space-between">
          ...
          <Grid
            ...
            className={classes.infoProvIconContainer}
          >
            <Grid item container xs={6}>
              ...
              <Grid item xs={12}>
                <Button
                  ...
                  onClick={() =>
                    openLogDialog(data.infoprovider_id, data.infoprovider_name)
                  }
                >
                  Logs einsehen
                </Button>
  ...
  return (
    <React.Fragment>
      <List>{props.infoprovider.map((e) => renderListItem(e))}</List>
      {showLogDialog && (
        <LogDialog
