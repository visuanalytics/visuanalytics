    ...
    return (
        <Dialog aria-labelledby="authDataDialog-title"
            ...
            <DialogContent dividers>
                <Grid container>
                    <Grid item xs={12}>
                        Erneute Eingabe der Authentifizierungsdaten ist auch Sicherheitsgründen notwendig.<br/>Bitte
                        geben sie für alle angezeigten Datenquellen ihre Authentifizierungsdaten erneut ein.
                    </Grid>
                    ...
                    <Grid item xs={12} className={classes.elementLargeMargin}>
                        <Typography variant="body1">
                            Authentifizierungsmethode dieser
                            Datenquelle: <strong>{resolveMethodName(props.selectionDataSources[selectedIndex].method)}</strong>
                        </Typography>
                    </Grid>
            ...
            <DialogActions>
                <Grid item className={classes.blockableButtonPrimary}>
                    <Button variant="contained" color="primary" disabled={!checkFinish()}
