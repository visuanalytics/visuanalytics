    ...
    <Grid container>
        ...
        <Grid item container xs={8}>
          <Grid item xs={12}>
            <TextField
              ...
              variant="filled"
              color="primary"
              label={"Video-Job-Name"}
              value={props.videoJobName}
              onChange={(e) =>
                props.setVideoJobName(e.target.value.replace(" ", "_"))
              }
            />
          </Grid>
        </Grid>
        <Grid item container xs={3} justify="flex-end">
          <Grid item className={classes.verticalAlignBlockableButtonPrimary}>
            <Button
              ...
              className={classes.alignLeftButton}
            >
              zurück
            </Button>
          </Grid>
      ...
      <Grid item container xs={12} justify="space-between">
        ...
        <Grid item container xs={3}>
          <Grid item xs={12}>
            <Box
              ...
              border={4}
              className={classes.availableScenesBox}
            >
              <List>
                {props.availableScenes.map((scene) =>
                  renderAvailableScene(scene)
                )}
              </List>
            </Box>
          </Grid>
        ...
        <Grid container item xs={12} className={classes.elementLargeMargin}>
          <Grid item>
            <Alert severity="info">
              Jede für das Video gewählte Szene muss einen TTS-Abschnitt
              enthalten. Dies ist aus technischen Gründen notwendig.
            </Alert>
          </Grid>
        </Grid>
      </Grid>
